...
impl Config {
    fn from_source(get: impl Fn(&str) -> Option<String>) -> Result<Config, ConfigError> {
        ...
        Ok(Config { solana_rpc_url, database_url, jwt_secret })
    }
...
use super::*;
    ...
    fn happy_path_config() {
        ...
        assert_eq!(result, Ok(Config { solana_rpc_url: "dummy".to_string(), database_url: "dummy".to_string(), jwt_secret: "dummy".to_string() }));
    }
}
